    ...
    <Container sx={containerStyles} maxWidth={false} disableGutters>
      ...
      <Page {...props}>
        ...
        <Container sx={wrapperStyles}>
          ...
          <Typography component={'p'} align="justify" sx={paragraphStyles}>
            The data in this project comes directly from NASA and IPAC at
            Caltech, the majority of which was collected by the&nbsp;
            <a href="https://en.wikipedia.org/wiki/Kepler_(spacecraft)">
              Kepler and K2
            </a>
            &nbsp; missions since being launched in 2009. NASA maintains a list
            of over 5,000 potential stellar candidates for future observations.
          </Typography>
          <Typography component={'p'} align="justify" sx={paragraphStyles}>
          ...
          <Typography component={'p'} align="justify" sx={paragraphStyles}>
            Browse the project to see visual plots of the solar systems with
            valid data...
          </Typography>
          <Typography component={'p'} align="justify" sx={paragraphStyles}>
            The available data from NASA comes from a SQL table view that
            combines star and planet data together. While this allows for
            compact and less-effort storage, the hierarchical or relationship of
            planets to stars is lost. Those relationships are rebuilt in
            JavaScript files of these web pages.
          </Typography>
          <Typography component={'p'} align="justify" sx={paragraphStyles}>
            ...
            animate a rough estimation of the geometry and scale of these
            distant star systems. Without some of the variables, a section of
            stars and planets can not be plotted and therefore are not included
            in the snapshot of data used here.
          </Typography>
          <Typography component={'p'} align="justify" sx={paragraphStyles}>
            In cases where it makes sense, some data can be &apos;nudged&apos;
            to a default value. For example, if the oribital eccentricity of a
            planet is unknown, the value can be set to 0.0 (a perfect circle)
            for plotting purposes. While inaccurate, that estimated orbit will
            be highlighted as &apos;estimated&apos; when the planet&apos;s orbit
            is plotted on the Solar System page while still presenting an
            acceptable map of that solar system.{' '}
          </Typography>
          <Divider sx={dividerStyles} />
