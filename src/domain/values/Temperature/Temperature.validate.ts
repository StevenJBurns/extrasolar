...
export const validateTemperature = (value: number, scale: string): Either<TemperatureError, void> =>
  chainEither((validScale: TemperatureScale) =>
    checkValue(value, validScale))(
      checkScale(scale)
    );
